...
just tta-diagnostic <run> # evaluate hflip TTA on a run validation split
...
- `train.py` supports `--augmentation none|mild|targeted|stronger`; `mild` remains the default and stronger recipes are explicit data-engineering experiment settings.
